...
if [[ -z "${PEI_STAGE_DIR_1:-}" ]]; then
  _peidocker_die "PEI_STAGE_DIR_1 is not set; cannot locate stage-1 codex-cli installer"
fi

stage1_script="$PEI_STAGE_DIR_1/system/codex-cli/install-codex-cli.sh"
