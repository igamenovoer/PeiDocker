...
#                          Default: $HOME/.nvm
#   --cache-dir <dir>      Directory for cached NVM clone (optional)
...
#   - $PEI_STAGE_DIR_1 environment variable should be set for cached install
#
# Post-installation:
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        *)
            ...
            echo "Usage: $0 [--install-dir <directory>] [--cache-dir <directory>] [--with-cn-mirror] [--version <ver>]"
            echo "  --install-dir <dir>  Custom directory to install NVM (default: \$HOME/.nvm)"
            echo "  --cache-dir <dir>    Directory for cached NVM clone (default: \$PEI_STAGE_DIR_1/tmp or /tmp)"
