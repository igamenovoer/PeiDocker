...
apt_repo : str = 'tuna'
fn_output = f'pei_docker/examples/with-proxy-manually.yml'
...
cfg_obj.stage_1.apt.repo_source='tuna'
...
cfg_obj.stage_1.proxy.pop('enable_globally')
cfg_obj.stage_1.proxy.pop('remove_after_build')
cfg_obj.stage_1.proxy.pop('use_https')
