# Spec: installer-flag-conventions

## Purpose

Define conventions for installer script path and cache/tmp flags so stage-1 canonical installers remain storage-agnostic and caller-controlled.
